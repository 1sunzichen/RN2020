...
import {View, Text, StyleSheet, Button,Modal,TouchableOpacity,DeviceInfo} from 'react-native';
import FontAwesome from 'react-native-vector-icons/FontAwesome';
import TimeSpan from '../modal/TImeSpans';
import MaterialIcons from 'react-native-vector-icons/MaterialIcons';

export const TimeSpans=[new TimeSpan("今天",'since=daily'),
new TimeSpan("本周",'since=weekly'),new TimeSpan("本月",'since=monthly')];
